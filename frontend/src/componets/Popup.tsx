...
export default function Popup({ show, setShow, data, action }: PopupProps) {
    ...
    return (
        <div className="sidebar">
            ...
            <ul className="sidebar-list">
                ...
                {user?.rol === "profesor" && (
                    <li><NavLink to="/lista-alumnos" className={({ isActive }) => (isActive ? "active" : "")}>Lista Alumnos</NavLink></li>
                )}
                {user?.rol === "alumno" && (
                    <li><NavLink to="/notas" className={({ isActive }) => (isActive ? "active" : "")}>Mis Notas</NavLink></li>
                )}
            </ul>
        </div>
    );
...
export default function Table({ data, columns, filter, dataToFilter, initialSortName, onSelectionChange }: TableProps) {
